...
Security reports go through the private process in [`SECURITY.md`](SECURITY.md),
not to individual maintainers. The maintainers triage and coordinate fixes.

## Emeritus maintainers

People who previously maintained the project and have stepped down. None yet.

## Becoming a maintainer

See [Becoming a maintainer](GOVERNANCE.md#becoming-a-maintainer) in the
governance document.
