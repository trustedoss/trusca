...
[![Release](https://img.shields.io/badge/release-v0.22.4-0f766e.svg)](CHANGELOG.md)
...
- **Read-only live demo** — try the hosted instance at **[trusca-demo.duckdns.org](https://trusca-demo.duckdns.org)** (`dev@demo.trustedoss.dev` / `DemoTest2026!`), or run your own with `DEMO_READ_ONLY=true`. See [Live demo](https://trustedoss.github.io/trusca/docs/installation/live-demo).
