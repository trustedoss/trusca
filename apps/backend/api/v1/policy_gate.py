...
def _build_response_body(result: GateResult) -> GateResultResponse:
    return GateResultResponse(
        ...
        kev_gate_count=result.kev_gate_count,
        kev_gate_enabled=result.kev_gate_enabled,
        kev_outcome=result.kev_outcome,
        kev_on_missing_data=result.kev_on_missing_data,
        eol_gate_count=result.eol_gate_count,
        eol_gate_enabled=result.eol_gate_enabled,
        eol_outcome=result.eol_outcome,
        eol_on_missing_data=result.eol_on_missing_data,
        incomplete_scan_gate_enabled=result.incomplete_scan_gate_enabled,
        incomplete_scan_outcome=result.incomplete_scan_outcome,
        incomplete_scan_basis=result.incomplete_scan_basis,
        incomplete_scan_on_unknown=result.incomplete_scan_on_unknown,
