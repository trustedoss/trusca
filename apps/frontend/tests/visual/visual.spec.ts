...
// The font wait moved to `../_harness/fonts` (#113): the documentation
// screenshot pipeline takes the same shutter and had no wait at all, so a
// capture run that lost the race shipped a page in the fallback typeface into
// the published guides. One definition, both pipelines.
