...
describe("LicensesTab", () => {
  ...
  // toggle-off transition). A browser-environment E2E is the natural place
  // to assert the cache-respecting, user-visible toggle round-trip.
  it.skip("toggles the chart filter off when the same segment is re-clicked", async () => {
