 ...
 * the four official brand colors (Google brand guidelines forbid recoloring
 * the mark) — those four hex literals are deliberate brand assets, NOT theme
 * tokens, and intentionally bypass the CLAUDE.md "no hex literals" rule for
 * that reason.
 */
