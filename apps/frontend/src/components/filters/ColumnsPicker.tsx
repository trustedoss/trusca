 ...
 *
 * A Columns checkbox-list dropdown on the right edge of a findings toolbar is
 * the established pattern for letting a triager hide / show table columns —
 * opaque popover, one checkbox row per column, "required" columns rendered
 * disabled+checked so the user cannot hide the row-identifying ones (CVE ID /
 * Component / Severity). This primitive implements that shape.
 *
