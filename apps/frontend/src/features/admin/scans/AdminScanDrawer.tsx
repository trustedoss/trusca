  ...
  return (
    <Badge
      ...
      className={cn(
        ...
        tone === "ok" && "border-status-success-border bg-status-success-subtle text-status-success-foreground",
        tone === "running" &&
          "border-blue-300 bg-blue-50 text-blue-700",
        tone === "down" && "border-status-danger-border bg-status-danger-subtle text-status-danger-foreground",
            ...
            {cancellable ? (
              ...
              >
                {!confirming ? (
                  ...
                  <div
                    className="flex w-full flex-col gap-2 rounded-md border border-status-warning-border bg-status-warning-subtle px-3 py-2 text-sm text-status-warning-foreground"
