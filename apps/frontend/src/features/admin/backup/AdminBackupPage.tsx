    ...
    <div className="flex h-full flex-col" data-testid="admin-backup-page">
      ...
      {restoreQueued ? (
        <div className="border-b bg-amber-50 px-6 py-3" data-testid="admin-backup-restore-queued">
          <Alert className="border-status-warning-border bg-status-warning-subtle text-status-warning-foreground">
            <AlertDescription>
      ...
      {showConfirm ? (
        ...
        >
          <td colSpan={6} className="px-6 py-3">
            <div className="flex flex-wrap items-center justify-between gap-2 rounded-md border border-status-warning-border bg-status-warning-subtle px-3 py-2 text-sm text-status-warning-foreground">
