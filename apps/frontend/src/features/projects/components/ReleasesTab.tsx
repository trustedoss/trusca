...
function riskToneClass(score: number | null): string {
  ...
  if (score >= 75) return "text-risk-critical-foreground";
  if (score >= 50) return "text-risk-high-foreground";
  if (score >= 25) return "text-risk-medium-foreground";
  if (score > 0) return "text-risk-low-foreground";
  return "text-risk-info-foreground";
}
