...
function DrawerMetaSection({ detail }: MetaProps) {
  ...
  return (
    ...
    >
      ...
      {/* S5-B — OSORI's reading, kept visually separate from our own summary
          above. Most valuable when that summary is null, which is every
          license outside the 52-entry catalogue. */}
      <OsoriReferencePanel
        osori={detail.osori}
        hasOwnSummary={detail.summary != null}
      />
