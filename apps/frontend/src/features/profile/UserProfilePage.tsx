...
function IdentityRow({
  ...
  return (
    ...
    >
      ...
      {confirming ? (
        <div
          className="mx-3 mb-3 flex flex-col gap-2 rounded-md border border-status-warning-border bg-status-warning-subtle px-3 py-2 text-sm text-status-warning-foreground"
