...
| §0.5 | **Wave 6 (DT 제거 + Trivy 교체)** | 7(+선택1) | 2 | 🟦 진행중 — #45 ✅ → #40 ✅(PR #196) → #41 🟦 (게이트 없이 정보용 측정) → #42 → #43a~e → #44 (v2.3.1 prereq 스킵, shadow 게이트 스킵, v2.4.0이 첫 공개 릴리스) |
