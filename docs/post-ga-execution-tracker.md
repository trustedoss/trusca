...
| §0.5 | **Wave 6 (DT 제거 + Trivy 교체)** | 8(+선택1) | 1 | 🟦 진행중 — #45 ✅ → #40 🟦(PR #196) → #41 → shadow → #42·#43a~e → #44 (v2.3.1 prereq 스킵, v2.4.0이 첫 공개 릴리스) |
