...
| 리뷰 일자 | 2026-07-03 (4차 — Phase D 착수 전) |
...
| 5 | AI 특화 라이선스 플래그 (행동제한 RAIL/Llama/Gemma, 비상업 CC-BY-NC) | P2 | **in-progress (Phase D)** | BomLens `license-flags.jq`(불변) 포팅 + "License review needed" 표시 ↔ TRUSCA 카탈로그(32개)에 해당 어휘 없음. Phase A ML-BOM 수용 위에 착수 |
