...
| 리뷰 일자 | 2026-07-03 (3차 — Phase B 착수 전) |
...
| 3 | NOTICE 라이선스 전문 번들 + copyright 표시 | P1 | **in-progress (Phase B)** | BomLens 전문 21종 + SPDX 공식 11종 = 카탈로그 32종 전수 벤더링 완료(집합 정합 확인) ↔ 로더·렌더·copyright 구현 중 |
