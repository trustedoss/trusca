...
| 7 | 라이선스 분류 카탈로그 확장 (32개 → SPDX 주요 라이선스) | P2 | in-progress (Phase E) | BomLens `spdx-normalize.jq` 매핑 참고 ↔ TRUSCA `_LICENSE_CATEGORY_DEFAULTS` 32개, 미등재는 unknown. Phase E: 별칭 정규화 포팅(`license_normalize.py`) + 카탈로그 20종 확장(32→52) |
