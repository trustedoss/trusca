...
happened. Logs and screenshots help.
...
If you would like to fix a bug or build a feature yourself, see
[`CONTRIBUTING.md`](CONTRIBUTING.md) for local setup and the pull-request
process.
