...
title: TRUSCA 비교
sidebar_label: 비교
description: TRUSCA와 상용 SCA 도구, Dependency-Track, SW360을 정직하게 비교합니다 — 강점과 현재 한계.
---
...
[`ROADMAP.md`](https://github.com/trustedoss/trusca/blob/main/ROADMAP.md)를
참고하십시오.
:::
...
| | TRUSCA | 상용 SCA | Dependency-Track | Eclipse SW360 |
|---|---|---|---|---|
...
- **자동 리메디에이션.** 일부 상용 도구는 수정 PR을 자동으로 생성합니다. TRUSCA는
...
- **우선순위화 신호.** EPSS 우선순위화는 1급 신호로 제공됩니다 — 컬럼·정렬·필터·
  빌드 게이트 임계값. Reachability 분석은 `govulncheck`로 Go에 대해 제공되며,
...
사용합니다(결정 배경은 [ADR-0001](https://github.com/trustedoss/trusca/blob/main/docs/decisions/0001-replace-dt-with-trivy.md) 참조).
...
- **이중 언어 UI.** 영어와 한국어.
- **트리아지 신호.** EPSS는 1급 신호(컬럼·정렬·필터·빌드 게이트 임계값). KEV 배지가
...
[로드맵](https://github.com/trustedoss/trusca/blob/main/ROADMAP.md)에
있습니다:
...
- [로드맵](https://github.com/trustedoss/trusca/blob/main/ROADMAP.md) — "로드맵" 항목이 도착하는 곳
