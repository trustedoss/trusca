...
| **반려** | 검토자. | 컴포넌트 제거 권장; 결정은 감사용으로 기록. [반려 결정 caveat](#rejected-verdict) 참고 — v0.10.0 에서 빌드 게이트는 반려 결정에 자동으로 차단되지 **않습니다**. |
